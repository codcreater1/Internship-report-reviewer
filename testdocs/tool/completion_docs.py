...
Produces the completion package this service consumes: the student's report,
the employer evaluation form, and the attendance record.
...
that — see backend/app/core/report_constants.py.
"""
